  ...
  return (
    <form onSubmit={onSubmit} noValidate className="w-full">
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        <button
          type="submit"
          className="inline-flex h-12 items-center justify-center gap-2 rounded-pill bg-ink-900 px-6 font-medium text-white transition-colors hover:bg-ink-700"
        >
          Subscribe
      ...
      {status === "error" ? (
        <p className={cn("mt-2 text-small", onLight ? "text-accent-200" : "text-error")}>
